...
if ( ! class_exists( 'BF_Admin_Page_Class') ) :
  ...
  class BF_Admin_Page_Class {
    ...
    public function DisplayPage() {
      $p1xtr_plugin_user = get_option($this->args['pixter_image_digital_license'] . '_user');
      $p1xtr_plugin_is_guest_user = get_option($this->args['pixter_image_digital_license'] . '_is_guest_user');
      do_action($this->args['pixter_image_digital_license'] . '_admin_page_class_before_page');
      ...
      if (empty($p1xtr_plugin_user) || $p1xtr_plugin_is_guest_user == true){
        do_action($this->args['pixter_image_digital_license'] . '_admin_page_class_display_register_page');
      }
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
    ...
    public function show_field_cond( $field, $meta ) {
      $p1xtr_plugin_options = get_option($this->args['pixter_image_digital_license'] .'_options');
      $this->show_field_begin($field, $meta);
      $checked = false;
