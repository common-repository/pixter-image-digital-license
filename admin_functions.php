...
function p1xtr_pixter_image_digital_license_admin_page_register($pluginName,$pluginTitle)
{
...
registerAction = 'register_' + '$pluginName'+'_user';
    ...
    $pixter_image_digital_license_is_guest_user = get_option('pixter_image_digital_license_is_guest_user');

    $hideRegPage = '';
    if(empty($pixter_image_digital_license_is_guest_user) || $pixter_image_digital_license_is_guest_user == true ){
        $hideRegPage = 'hidden';
    }
...
function p1xtr_pixter_image_digital_license_admin_before_page()
{
    $logo = plugins_url('logo.png', __FILE__);
    echo "
			<style>
...
$p1xtr_pixter_image_digital_license_fields = array(
    array(
        "type" => "cond",
        "name" => __("Turn Image License and Protection plugin:", 'pixter-me'),
...
class p1xtr_pixter_image_digital_license_admin_tools {
    private $pluginName;
